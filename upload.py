...
options.add_argument("user-data-dir=C:\\Users\\l84233197\\AppData\\Local\\Google\\Chrome Beta\\User Data\\")
...
simp_path = "C:\\code\\content\\videos\\" + str(time.strftime("%Y-%m-%d")) + ".mp4"
